...
TRANSLATIONS = {
    "en": {
        ...
        "status_external_merged": "External changes merged. Save to write the combined testbench.",
        "status_external_merge_conflict": "External merge needs manual resolution ({count} conflict(s)).",
        ...
        "placeholder_project": "Open an Icestudio design or Verilog testbench...",
        "mode_auto": "Auto",
        ...
        "dialog_open_project": "Open BenchSim Project",
        "filter_project": "BenchSim projects (*.ice *_tb.v);;Icestudio designs (*.ice);;Verilog testbenches (*_tb.v);;Verilog files (*.v)",
        "action_open_icestudio": "Open Icestudio Design...",
        "action_open_verilog": "Open Verilog Testbench...",
        "tooltip_open_icestudio": "Open an Icestudio .ice design (Ctrl+Shift+O)",
        "tooltip_open_verilog": "Open a Verilog testbench (Ctrl+O)",
        "tooltip_reload": "Reload project files",
        "tooltip_settings": "Simulator settings",
        "dialog_select_folder": "Select a folder",
        "dialog_select_icestudio": "Select Icestudio Design",
        "dialog_select_testbench": "Select Verilog Testbench",
        "dialog_icestudio_project": "Icestudio Project",
        "filter_icestudio": "Icestudio designs (*.ice)",
        "filter_testbench": "Verilog testbenches (*_tb.v);;Verilog files (*.v)",
        "status_icestudio_opened": "Opened Icestudio design: {name}",
        ...
        "external_merge_conflict": (
            "<b>External merge needs manual resolution.</b><br/>"
            "{count} conflicting section(s) were kept local. "
            "Use Keep local or edit the testbench before saving."
        ),
    },
    "es": {
        "app_name": "BenchSim",
        ...
        "status_external_merged": "Los cambios externos se combinaron. Guarda para escribir el testbench combinado.",
        "status_external_merge_conflict": "La combinación externa requiere resolución manual ({count} conflicto(s)).",
        ...
        "placeholder_project": "Abre un diseño Icestudio o un testbench Verilog...",
        "mode_auto": "Auto",
        "mode_icestudio": "Icestudio",
        ...
        "tooltip_open_project": "Abrir proyecto",
        "dialog_open_project": "Abrir proyecto BenchSim",
        "filter_project": "Proyectos BenchSim (*.ice *_tb.v);;Diseños Icestudio (*.ice);;Testbenches Verilog (*_tb.v);;Archivos Verilog (*.v)",
        "action_open_icestudio": "Abrir diseño Icestudio...",
        "action_open_verilog": "Abrir testbench Verilog...",
        "tooltip_open_icestudio": "Abrir un diseño .ice de Icestudio (Ctrl+Shift+O)",
        "tooltip_open_verilog": "Abrir un testbench Verilog (Ctrl+O)",
        ...
        "dialog_select_icestudio": "Selecciona diseño Icestudio",
        "dialog_select_testbench": "Selecciona testbench Verilog",
        "dialog_icestudio_project": "Proyecto Icestudio",
        "filter_icestudio": "Diseños Icestudio (*.ice)",
        "filter_testbench": "Testbenches Verilog (*_tb.v);;Archivos Verilog (*.v)",
        "status_icestudio_opened": "Diseño Icestudio abierto: {name}",
        ...
        "external_merge_conflict": (
            "<b>La combinación externa requiere resolución manual.</b><br/>"
            "{count} sección(es) en conflicto se mantuvieron locales. "
            "Usa Mantener local o edita el testbench antes de guardar."
        ),
    },
}
